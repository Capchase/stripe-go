...
import (
	...
	"github.com/Capchase/stripe-go/v72/account"
	"github.com/Capchase/stripe-go/v72/accountlink"
	"github.com/Capchase/stripe-go/v72/applepaydomain"
	"github.com/Capchase/stripe-go/v72/balance"
	"github.com/Capchase/stripe-go/v72/balancetransaction"
	"github.com/Capchase/stripe-go/v72/bankaccount"
	billingportalconfiguration "github.com/Capchase/stripe-go/v72/billingportal/configuration"
	billingportalsession "github.com/Capchase/stripe-go/v72/billingportal/session"
	"github.com/Capchase/stripe-go/v72/capability"
	"github.com/Capchase/stripe-go/v72/card"
	"github.com/Capchase/stripe-go/v72/charge"
	checkoutsession "github.com/Capchase/stripe-go/v72/checkout/session"
	"github.com/Capchase/stripe-go/v72/countryspec"
	"github.com/Capchase/stripe-go/v72/coupon"
	"github.com/Capchase/stripe-go/v72/creditnote"
	"github.com/Capchase/stripe-go/v72/customer"
	"github.com/Capchase/stripe-go/v72/customerbalancetransaction"
	"github.com/Capchase/stripe-go/v72/discount"
	"github.com/Capchase/stripe-go/v72/dispute"
	"github.com/Capchase/stripe-go/v72/ephemeralkey"
	"github.com/Capchase/stripe-go/v72/event"
	"github.com/Capchase/stripe-go/v72/fee"
	"github.com/Capchase/stripe-go/v72/feerefund"
	"github.com/Capchase/stripe-go/v72/file"
	"github.com/Capchase/stripe-go/v72/filelink"
	"github.com/Capchase/stripe-go/v72/invoice"
	"github.com/Capchase/stripe-go/v72/invoiceitem"
	"github.com/Capchase/stripe-go/v72/issuing/authorization"
	issuingcard "github.com/Capchase/stripe-go/v72/issuing/card"
	"github.com/Capchase/stripe-go/v72/issuing/cardholder"
	issuingdispute "github.com/Capchase/stripe-go/v72/issuing/dispute"
	"github.com/Capchase/stripe-go/v72/issuing/transaction"
	"github.com/Capchase/stripe-go/v72/loginlink"
	"github.com/Capchase/stripe-go/v72/mandate"
	"github.com/Capchase/stripe-go/v72/oauth"
	"github.com/Capchase/stripe-go/v72/order"
	"github.com/Capchase/stripe-go/v72/orderreturn"
	"github.com/Capchase/stripe-go/v72/paymentintent"
	"github.com/Capchase/stripe-go/v72/paymentmethod"
	"github.com/Capchase/stripe-go/v72/paymentsource"
	"github.com/Capchase/stripe-go/v72/payout"
	"github.com/Capchase/stripe-go/v72/person"
	"github.com/Capchase/stripe-go/v72/plan"
	"github.com/Capchase/stripe-go/v72/price"
	"github.com/Capchase/stripe-go/v72/product"
	"github.com/Capchase/stripe-go/v72/promotioncode"
	"github.com/Capchase/stripe-go/v72/radar/earlyfraudwarning"
	"github.com/Capchase/stripe-go/v72/radar/valuelist"
	"github.com/Capchase/stripe-go/v72/radar/valuelistitem"
	"github.com/Capchase/stripe-go/v72/refund"
	"github.com/Capchase/stripe-go/v72/reporting/reportrun"
	"github.com/Capchase/stripe-go/v72/reporting/reporttype"
	"github.com/Capchase/stripe-go/v72/reversal"
	"github.com/Capchase/stripe-go/v72/review"
	"github.com/Capchase/stripe-go/v72/setupattempt"
	"github.com/Capchase/stripe-go/v72/setupintent"
	"github.com/Capchase/stripe-go/v72/sigma/scheduledqueryrun"
	"github.com/Capchase/stripe-go/v72/sku"
	"github.com/Capchase/stripe-go/v72/source"
	"github.com/Capchase/stripe-go/v72/sourcetransaction"
	"github.com/Capchase/stripe-go/v72/sub"
	"github.com/Capchase/stripe-go/v72/subitem"
	"github.com/Capchase/stripe-go/v72/subschedule"
	"github.com/Capchase/stripe-go/v72/taxid"
	"github.com/Capchase/stripe-go/v72/taxrate"
	terminalconnectiontoken "github.com/Capchase/stripe-go/v72/terminal/connectiontoken"
	terminallocation "github.com/Capchase/stripe-go/v72/terminal/location"
	terminalreader "github.com/Capchase/stripe-go/v72/terminal/reader"
	"github.com/Capchase/stripe-go/v72/token"
	"github.com/Capchase/stripe-go/v72/topup"
	"github.com/Capchase/stripe-go/v72/transfer"
	"github.com/Capchase/stripe-go/v72/usagerecord"
	"github.com/Capchase/stripe-go/v72/usagerecordsummary"
	"github.com/Capchase/stripe-go/v72/webhookendpoint"
)
